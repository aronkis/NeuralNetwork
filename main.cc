...
Memory Management
  ...
  - Tensor operations: In Convolution2D.cc, the tensor-to-matrix conversions could be optimized with
   better memory layouts

  Computational Efficiency

  - BLAS optimization: The comment about EIGEN_USE_BLAS in Convolution2D.h suggests this could be
  ...
  - Winograd Convolution2D: For 3x3 convolutions, Winograd algorithm could be faster
