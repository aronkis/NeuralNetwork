...
int main()
{
	...
	Eigen::Tensor<double, 4> X_tensor, X_test_tensor;
  	Eigen::Tensor<double, 2> y_tensor, y_test_tensor;
  	NEURAL_NETWORK::Helpers::CreateDataSets(dataset_url, output_dir, X_tensor, y_tensor, X_test_tensor, y_test_tensor);
	// Print the first 10 elements of X_tensor (flattened)
	// Print the first 10 images (each image is 28x28, channel=1)
	...
	// 			std::cout << X_tensor(img, row, col, 0) << " ";
	// 		}
	// 		std::cout << std::endl;
	// 	}
	// 	std::cout << std::endl;
